...
public final class NebulaeLanguageProvider extends RegistrateLangProvider {
    ...
    protected void addTranslations() {
        ...
        add("gui.nebulaeae2.activity.title", "Network Activity");
        add("gui.nebulaeae2.activity.history", "History");
        add("gui.nebulaeae2.activity.return_cpu", "CPU");
        add("gui.nebulaeae2.activity.manual", "Manual Jobs");
        add("gui.nebulaeae2.activity.automated", "Automated Jobs");
        add("gui.nebulaeae2.activity.flow", "Flow");
        add("gui.nebulaeae2.activity.search", "Search...");
        add("gui.nebulaeae2.activity.all", "All Types");
        add("gui.nebulaeae2.activity.active", "Active");
        add("gui.nebulaeae2.activity.completed", "Completed");
        add("gui.nebulaeae2.activity.canceled", "Canceled");
        add("gui.nebulaeae2.activity.everyone", "Everyone");
        add("gui.nebulaeae2.activity.mine", "Mine");
        add("gui.nebulaeae2.activity.back", "Back");
        add("gui.nebulaeae2.activity.planned", "Planned Materials");
        add("gui.nebulaeae2.activity.empty", "No activity.");
        add("gui.nebulaeae2.activity.emitted", "Planned supply");
        add("gui.nebulaeae2.activity.incoming", "Incoming: %s (%s)");
        add("gui.nebulaeae2.activity.outgoing", "Outgoing: %s (%s)");
        add("gui.nebulaeae2.activity.net", "Net: %s (%s)");
        add("gui.nebulaeae2.activity.requester", "Requested by: %s");
        add("gui.nebulaeae2.activity.unknown", "Unknown source");
        add("gui.nebulaeae2.activity.started", "Started: %s");
        add("gui.nebulaeae2.activity.duration", "Total Duration: %s");
        add("gui.nebulaeae2.activity.delivered", "Sent Output: %s");
        add("gui.nebulaeae2.activity.cpu", "CPU: %s");
        add("gui.nebulaeae2.activity.details", "Click for used materials");
        add("gui.nebulaeae2.activity.recorded", "%s recorded");
        add("gui.nebulaeae2.activity.page", "Page %s");
        add("gui.nebulaeae2.activity.sort", "Sort");
        add("gui.nebulaeae2.activity.loading", "Loading...");
        add("gui.nebulaeae2.activity.sort.amount", "Total transferred (incoming + outgoing)");
        add("gui.nebulaeae2.activity.sort.name", "Resource name");
        add("gui.nebulaeae2.activity.sort.incoming", "Incoming amount");
        add("gui.nebulaeae2.activity.sort.outgoing", "Outgoing amount");
        add("gui.nebulaeae2.activity.sort.net", "Net amount (incoming - outgoing)");
        add("gui.nebulaeae2.activity.sort.az", "A to Z");
        add("gui.nebulaeae2.activity.sort.za", "Z to A");
        add("gui.nebulaeae2.activity.sort.lowest", "Lowest first");
        add("gui.nebulaeae2.activity.sort.highest", "Highest first");
        add("gui.nebulaeae2.activity.sort.reverse", "Click again to reverse.");
        add("gui.nebulaeae2.activity.sort.select", "Click to select this sort.");
        add("gui.nebulaeae2.activity.output_header", "Output");
        add("gui.nebulaeae2.activity.status_header", "Status");
